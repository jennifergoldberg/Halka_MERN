...
function ResultCardHotline() {
  return(
    <Card>
          <Image src='/assets/start-hero.jpg' wrapped ui={false} />
          <Card.Content>
            <Card.Header>Hotline</Card.Header>
            <Card.Description>
              <p>
          ...
          <Card.Content extra>
            <a href='https://www.healthytruck.org/depression-in-truckers/' target="_blank">
              <Icon name='linkify' />
              Read more
            </a>
          </Card.Content>
...
export default ResultCardHotline;